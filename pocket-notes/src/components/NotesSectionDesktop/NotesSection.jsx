  ...
  return (
    <div className={styles.container}>
      <div className={styles.navbar}>
        <div className={styles.circle} style={{ backgroundColor: selectedMessage.color }}>{selectedMessage.initials}</div>
      ...
      <div className={styles.inputContainer}>
        ...
        />
        <img src={sendImage} className={styles.sendImg} alt='send'onClick={handleSendClick}/>
        </div>
      </div>
    </div>
  )
